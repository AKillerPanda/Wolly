...
- 2× 1.47" LCD, Waveshare-class (172×320, 4-wire SPI, RGB565). The exact ST7789
  variant (V / V2 / V3) varies across this module class and affects the init
  sequence — verify your unit's controller and the column offset (don't assume
  Waveshare's 34 px blindly; use `--calibrate`).
